		...
		<div class="container">
			...
			<nav id="nav">
				<ul>
					...
					<li class="active"><a href="list.bd">게시판</a></li>
			...
			<div class="row">
				<div class="12u">
					<section>
						...
						<form action="list.bd" method="post" style="text-align: right;">
						...
						<table border=1 style="width: 100%">
							...
							<tr>
								<td align="right" colspan="6"><input type="button"
									value="게시글 등록" onclick="location.href='insert.bd'"></td>
							</tr>
